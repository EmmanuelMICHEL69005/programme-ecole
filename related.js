(function(){
  ...
  var RELATED = {
    ...
    'division-ce2.html':    [{h:'multiplication-division-ce2.html',l:'Multiplication et division CE2'},{h:'tables-ce2.html',l:'Tables de multiplication CE2'},{h:'problemes.html',l:'Problèmes CE2'},{h:'calcul-cm1.html',l:'Les 4 opérations CM1 — étape suivante'}],
    'tables-ce2.html':      [{h:'multiplication-division-ce2.html',l:'Multiplication et division CE2'},{h:'division-ce2.html',l:'Division euclidienne CE2'},{h:'calcul-mental.html',l:'Calcul mental CE2'},{h:'calcul-cm1.html',l:'4 opérations CM1 — étape suivante'}],
    ...
    'geometrie-cm1.html':   [{h:'angles-cm1.html',l:'Les angles CM1'},{h:'solides-cm1.html',l:'Solides CM1'},{h:'symetrie-ce2.html',l:'Symétrie CE2 — révision'},{h:'geometrie-cm2.html',l:'Géométrie CM2 — étape suivante'}],
    'angles-cm1.html':      [{h:'geometrie-cm1.html',l:'Géométrie CM1'},{h:'geometrie-ce2.html',l:'Géométrie CE2 — révision'},{h:'geometrie-cm2.html',l:'Géométrie CM2 — étape suivante'}],
